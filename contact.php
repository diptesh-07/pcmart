...
<body>
    ...
    <section class="ftco-section" style="background-color: #fffff0;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-3">
                    <h2 class="heading-section" style="margin-top: 20px;">Contact Us Here</h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-12" style="box-shadow: 0px 0px 36px 18px rgb(159 255 239);
                margin-bottom: 104px; border-radius: 9px;">
                    <div class="wrapper">
                        <div class="row no-gutters">
                            <div class="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
                                <div class="contact-wrap w-100 p-md-5 p-4">
                                    ...
                                    <div id="form-message-success" class="mb-4">
                                        You can send us massage from here, thank you!
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control contact-input" name="subject"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="message" class="form-control contact-input"
                            ...
                            <div class="col-lg-4 col-md-5 d-flex align-items-stretch">
                                <div class="info-wrap w-100 p-md-5 p-4" style="background-color: #00ffec;">
                                    ...
                                    <div class="dbox w-100 d-flex align-items-center">
                                        ...
                                        <div class="text pl-3">
                                            <p><span>Email:</span> <a
                                                    href="mailto:info@yoursite.com">info@pcmart.com</a></p>
                                        </div>
                                    </div>
                                    <div class="dbox w-100 d-flex align-items-center">
                                        <div class="icon d-flex align-items-center justify-content-center">
                                        ...
                                        <div class="text pl-3">
                                            <p><span>Website</span> <a href="#">www.pcmart.com</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
