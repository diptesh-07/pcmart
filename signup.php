...
<body>
    <div class="text-center justify-content-center">
        ...
        <form class="form-signin" style="    height: 100vh;
            display: flex;
            ...
            <input type="email" id="inputEmail" class="form-control" placeholder="Enter your Email address" required=""
                autofocus="">
            <label for="inputPassword" class="sr-only">Set your Password</label>
            <input type="password" id="inputPassword" class="form-control" placeholder="Set your Password" required="">
            <div class="checkbox mb-3">

                <label for="inputPassword" class="sr-only">Password</label>
                <input type="password" id="inputPassword" class="form-control" placeholder="Re-Enter your Password"
                    required="">
                <div class="checkbox mb-3">
                    <label>
                ...
                <button style="width: auto;" class="btn btn-lg btn-primary" type="submit">Create Account</button>
                <p class="mt-5 mb-3 text-muted">If you allready have account, <a href="login.php">login</a></p>
        </form>
    </div>
